...
z3:
	...
	cp Dockerfile.$(@).template $(@)/Dockerfile
	cp .dockerignore $(@)/.dockerignore
	sed -i -r 's|ARG FROM_IMAGE.*|ARG FROM_IMAGE="$(NAME)_builder"|g' $(@)/Dockerfile
...
fastcomp_fetch:
	...
	cp Dockerfile.$(@).template $(@)/Dockerfile
	cp .dockerignore $(@)/.dockerignore
	sed -i -r 's|ARG FROM_IMAGE.*|ARG FROM_IMAGE="$(NAME)_z3"|g' $(@)/Dockerfile
	sed -i -r 's|ARG CPU_CORES.*|ARG CPU_CORES="4"|g' $(@)/Dockerfile
...
fastcomp_stage1:
	...
	cp .dockerignore $(@)/.dockerignore
	sed -i -r 's|ARG FROM_IMAGE.*|ARG FROM_IMAGE="$(NAME)_fastcomp_fetch"|g' $(@)/Dockerfile
	sed -i -r 's|ARG CPU_CORES.*|ARG CPU_CORES="4"|g' $(@)/Dockerfile
	sed -i -r 's|ARG SDK_VERSION.*|ARG SDK_VERSION="1.37.37"|g' $(@)/Dockerfile
...
fastcomp_stage2:
	...
	cp Dockerfile.fastcomp_stage.template $(@)/Dockerfile
	cp .dockerignore $(@)/.dockerignore
	sed -i -r 's|ARG FROM_IMAGE.*|ARG FROM_IMAGE="$(NAME)_fastcomp_stage1"|g' $(@)/Dockerfile
	sed -i -r 's|ARG CPU_CORES.*|ARG CPU_CORES="4"|g' $(@)/Dockerfile
	sed -i -r 's|ARG SDK_VERSION.*|ARG SDK_VERSION="1.37.37"|g' $(@)/Dockerfile
	sed -i -r 's|ARG BUILD_TIMEOUT.*|ARG BUILD_TIMEOUT=$(BUILD_TIMEOUT)|g' $(@)/Dockerfile
	cd $(@) && docker build -t $(NAME)_$(@) .
...
fastcomp_stage3:
	...
	cp Dockerfile.fastcomp_stage.template $(@)/Dockerfile
	cp .dockerignore $(@)/.dockerignore
	sed -i -r 's|ARG FROM_IMAGE.*|ARG FROM_IMAGE="$(NAME)_fastcomp_stage2"|g' $(@)/Dockerfile
	sed -i -r 's|ARG CPU_CORES.*|ARG CPU_CORES="4"|g' $(@)/Dockerfile
	sed -i -r 's|ARG SDK_VERSION.*|ARG SDK_VERSION="1.37.37"|g' $(@)/Dockerfile
	sed -i -r 's|ARG BUILD_TIMEOUT.*|ARG BUILD_TIMEOUT=$(BUILD_TIMEOUT)|g' $(@)/Dockerfile
	cd $(@) && docker build -t $(NAME)_$(@) .
...
fastcomp_stage4:
	...
	cp Dockerfile.fastcomp_stage.template $(@)/Dockerfile
	cp .dockerignore $(@)/.dockerignore
	sed -i -r 's|ARG FROM_IMAGE.*|ARG FROM_IMAGE="$(NAME)_fastcomp_stage3"|g' $(@)/Dockerfile
	sed -i -r 's|ARG CPU_CORES.*|ARG CPU_CORES="4"|g' $(@)/Dockerfile
	sed -i -r 's|ARG SDK_VERSION.*|ARG SDK_VERSION="1.37.37"|g' $(@)/Dockerfile
	sed -i -r 's|ARG BUILD_TIMEOUT.*|ARG BUILD_TIMEOUT=$(BUILD_TIMEOUT)|g' $(@)/Dockerfile
	cd $(@) && docker build -t $(NAME)_$(@) .
...
fastcomp:
	...
	cp Dockerfile.$(@).template $(@)/Dockerfile
	cp .dockerignore $(@)/.dockerignore
	sed -i -r 's|ARG FROM_IMAGE.*|ARG FROM_IMAGE="$(NAME)_fastcomp_stage4"|g' $(@)/Dockerfile
	sed -i -r 's|ARG CPU_CORES.*|ARG CPU_CORES="4"|g' $(@)/Dockerfile
	sed -i -r 's|ARG SDK_VERSION.*|ARG SDK_VERSION="1.37.37"|g' $(@)/Dockerfile
	cd $(@) && docker build -t $(NAME)_$(@) .
